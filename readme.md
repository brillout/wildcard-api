...
It is financed with the [Lsos Basic](https://github.com/reframejs/wildcard-api/issues/56) allowing me to dedicate more time to provide you with a robust tool.
